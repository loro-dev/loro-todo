                ...
                <div className="help-quick-cards">
                    ...
                    <article className="help-quick-card">
                        ...
                        <div>
                            <h3>
                                Build with{" "}
                                <a href="https://loro.dev" target="_blank" style={{ color: "currentcolor" }}>
                                    Loro
                                </a>
                            </h3>
                            <p>
        ...
        <div className="confirm-backdrop" role="presentation" onClick={onCancel}>
            ...
            >
                ...
                <p id="delete-dialog-body">
                    Deleting only removes this list’s local data. It stays in the cloud for 7
                    days and you can re-add it with the invite URL.
                </p>
